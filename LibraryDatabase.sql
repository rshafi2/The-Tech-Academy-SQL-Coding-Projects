...
DROP TABLE BOOK_COPIES, BOOK_LOANS, BOOK_AUTHORS, BOOKS, PUBLISHER; 
...
VALUES 
	...
	SELECT * FROM BORROWER,BOOK_COPIES, BOOKS, LIBRARY_BRANCH;	
...
@BookID, BranchID
AS
Select Number_of_Copies from BOOK_COPIES where
